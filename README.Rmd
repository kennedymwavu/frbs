...
Designed to be used on the backend of your R applications, whether web or non-web.
...
customize your login & registration process/pages, while still using Firebase Auth.
...
Examples are provided [here](https://github.com/kennedymwavu/frbs-examples).
